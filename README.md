...
bootstrap/          → Bootstrap and cache configuration files
config/             → All project configuration files
database/           → Migrations, factories and seeders
docker/             → Docker service configuration (Nginx, PHP-FPM, etc.)
node_modules/       → Front-end dependencies (generated by npm)
public/             → Public web directory (index.php and assets)
resources/          → Blade views, raw SASS/JS assets, localization files
